					...
					if(p[dir1]=='0' and p[dir2]=='0'):#checks for overlapping
						...
						for i in range(9):
							if(arr1[i2][j2][i]=='0'):
								count=count+1
						if count==1:
							print 'hjfghfhgfhgghhjfhgfgdhgdgyiyghjvhdgfcvc'
							arr1[i2][j2]=replace(arr1[i2][j2],0,'3')
							arr2[i2][j2] = swap_array(arr1[i2][j2])
						count=0
						for i in range(9):
							if(arr1[i3][j3][i]=='0'):
								count=count+1
						if count==1:
							print 'hjfghfhgfhgghhjfhgfgdhgdgyiyghjvhdgfcvc'
							arr1[i2][j2]=replace(arr1[i2][j2],0,'3')
							arr2[i3][j3] = swap_array(arr1[i3][j3])'''
					else:
						flag=8
				else:
					flag=7
					...
					if(p[dir1]=='0' and p[dir2]=='0'):
						...
						for i in range(9):
							if(arr2[i2][j2][i]=='0'):
								count=count+1
						if count==1:
							print 'print pint prindfgdfgdfgdfgdfsgdfgdfg'
							arr2[i2][j2]=replace(arr2[i2][j2],0,'3')
							arr1[i2][j2] = swap_array(arr2[i2][j2])
						count=0
						for i in range(9):
							if(arr2[i3][j3][i]=='0'):
								count=count+1
						if count==1:
							print 'sdfsdfsdfsfsdfsdfsdfsfsdfsdfsdfsdfffffffffffffffffffffffffffffffffff'
							arr2[i2][j2]=replace(arr2[i2][j2],0,'3')
							arr1[i3][j3] = swap_array(arr2[i3][j3])'''
					else:
						flag=8
				else:
					flag=7
